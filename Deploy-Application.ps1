...
Try {
	...
	$CloseApps = "Code=Visual Studio Code"
	...
	$64bitAppInstallName = "Visual Studio Code"
	# Application install Path.
	$64bitAppInstallPath = "$PSScriptRoot\Files\VSCodeSetup-x64-1.70.1.exe"
	# Application  install parameters.
	$64bitAppInstallParam = "REBOOT=ReallySuppress /QN /VERYSILENT /NORESTART /SUPPRESSMSGBOXES /EULA=ACCEPT /TYPE=CLIENT" 
	...
	#$RemoveAppNamesMSI = @("")
	$RemoveAppNamesEXE = @("Visual Studio Code")

	##* Application uninstall parameters.
	# 64-bit application
	# 64-bit application uninstall name.
	$64bitAppUninstallName = "Visual Studio Code"
	# Application uninstall path.
	$64bitAppUninstallPath = "C:\Program Files\Microsoft VS Code\unins000.exe"
	# Application uninstall parameters.
	$64bitAppUninstallParam = "REBOOT=ReallySuppress /QN /VERYSILENT /NORESTART /SUPPRESSMSGBOXES"
